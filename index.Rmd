...
Além de diretor [Dan S. Reznik](https://www.linkedin.com/in/dan-s-reznik-bb49133/) (PhD em Ciência da Computação pela UC-Berkeley), contamos com uma equipe de jovens cientistas de dados formados pelas melhores Universidades do país.
...
```{r,echo=F,fig.align='center',out.width="80%"}
knitr::include_graphics("pics/projetos.png")
```
...
```{r,echo=F,fig.align='center',out.width="80%"}
knitr::include_graphics("pics/segmentacao.png")
```
