...
Dan S. Reznik é fundador da [DCS](index.html), ex-Cientista de Dados da Microsoft e Doutor em Ciência da Computação pela UC-Berkeley. Tem um portfolio de mais de 15 projetos em Analítica Avançada e Ciência de Dados em várias empresas e setores. Há 6 anos leciona cursos de pós-graduação em Ciência dos Dados na PUC-RJ, FGV-RJ e Fundação Dom Cabral (MG), além de treinamentos in-company (clientes recentes: NeoEnergia, Ministério Público-RJ, etc.). 
...
- NeoEnergia: Automação de Produção de Relatórios
