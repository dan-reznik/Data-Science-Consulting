...
A Ciência de Dados é um conjunto de metodologias e tecnologias focadas na **criação de valor** para um negócio a partir de múltiplas fontes de dados. O trabalho do cientista de dados é um fluxo iterativo que inclui aquisição, visualização/análise, manipulação (wrangling), e modelagem estatística (Machine Learning).

```{r,echo=F,fig.align='center',out.width="100%"}
knitr::include_graphics("pics/fluxo.png")
```

Somos fãs da metodologia [BADIR](https://aryng.com/aryng_BADIR_advantage), que inicia com a questão de negócios, passando por coleta, tratamento e análise, e termina com a comunicação e utilização dos insights (APIs, dashboards, relatórios):
